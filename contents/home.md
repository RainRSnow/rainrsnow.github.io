...
---
我目前正在北海道大学信息科学与技术研究科攻读博士学位。

我具有数字集成电路设计、FPGA 开发以及嵌入式系统方面的经验。本科阶段参与过脑机接口和 FPGA 应用相关项目，这些经历为我打下了扎实的软硬件协同设计基础。研究生阶段，我的研究主要聚焦于面向语音识别与异常检测的基于 RISC-V 的音频信号处理 SoC 框架，积累了 RTL 设计、功能验证、时序分析、硬件调试以及系统集成等方面的经验。